...
3. Publish a conformance statement in your project's README citing the specific Cloverleaf Standard version and level — e.g. *"Implements Cloverleaf Standard 0.8.3 at L2."*
